...
<head>
    ...
    <title>405 - Halaman tidak tersedia</title>
...
<body>
    <div id="error">
        ...
        <div class="error-page container">
            ...
            <img class="img-error" src="<?php echo base_url('assets/admin/dist/assets/images/samples/error-500.png'); ?>" alt="Not Found">
                <div class="text-center">
                    <h1 class="error-title">Tidak Tersedia</h1>
                    <p class="fs-5 text-gray-600">Halaman ini masih dalam pengembangan. Coba lagi nanti atau hubungi pengembang.</p>
                    <a href="<?php echo site_url('admin'); ?>" class="btn btn-lg btn-outline-success mt-3">Kembali</a>
                </div>
            </div>
        </div>
