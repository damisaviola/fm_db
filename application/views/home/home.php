            ...
            <section id="about" class="s-about target-section">
                ...
                <div class="s-about__info">
                    ...
                    <div class="row section-header" data-num="01">
                        <div class="column lg-6 stack-on-1000 title-block">
                            <h2 class="title text-display-1">Getting Started With FutsalMate.</h2>
                        </div>
                        <div class="column lg-6 stack-on-1000 desc-block">
                            <p class="desc lead">
                            Dengan FutsalMate, Anda bisa mengatur jadwal, pembayaran, dan laporan dengan mudah. 
                            Ciptakan pengalaman bermain futsal yang menyenangkan!
                            </p>
                        </div>
                    </div>
                            ...
                            <div class="swiper-container s-about__info-slider">
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="s-about__info-slide swiper-slide">
                                        ...
                                        <p>
                                        Sistem dirancang untuk memudahkan pengelolaan lapangan futsal. 
                                        Semua fitur dirancang untuk memberikan kenyamanan dan efisiensi 
                                    ...
                                    <div class="s-about__info-slide swiper-slide">
                                        ...
                                        <p>
                                        Antarmuka yang intuitif memungkinkan pengguna dari semua 
                                        level untuk mengelola lapangan futsal dengan mudah. .
                                        </p>
                                    </div>  <!-- end s-about__info-slide  -->
                                    ...
                                    <div class="s-about__info-slide swiper-slide">
                                        ...
                                        <p>
                                        Dengan alat analisis dan laporan kinerja yang kuat, 
                                        Anda dapat mengoptimalkan pengelolaan lapangan
                                        futsal dan meningkatkan kepuasan pelanggan.
                                        </p>
                                    </div>  <!-- end s-about__info-slide  -->
                                    ...
                                    <div class="s-about__info-slide swiper-slide">
                                        ...
                                        <p>
                                        Keamanan data adalah prioritas kami. Kami memastikan semua informasi 
                                        Anda terlindungi dengan sistem yang andal dan teruji.
                                        </p>
                                    </div>  <!-- end s-about__info-slide  -->
                        ...
                        <div class="column s-about__howto-process-block">
                            ...
                            <div class="s-about__howto-process">
                                <div class="s-about__howto-process-step">
                                    ...
                                    <p>
                                    Mulailah dengan mendaftar untuk membuat akun di platform kami. Isi formulir pendaftaran dan verifikasi akun Anda melalui email. 
                                    Proses ini cepat dan sederhana, memberi akses ke berbagai fitur.
                                    </p>
                                </div>
                                <div class="s-about__howto-process-step">
                ...
                <div class="s-about__features">
                    ...
                    <div class="row section-header" data-num="03">
                        ...
                        <div class="column lg-6 stack-on-1000 desc-block">
                            <p class="desc lead">
                            Aplikasi kami dirancang untuk merevolusi cara Anda mengelola lapangan futsal, 
                            menawarkan berbagai fitur hebat yang memenuhi kebutuhan Anda.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="row s-about__feature-list block-lg-one-third">
                        ...
                        <div class="column s-about__feature-item">
                            ...
                            <div class="s-about__feature-text">
                                ...
                                <p>Aplikasi sepenuhnya berbasis cloud, memungkinkan Anda mengaksesnya kapan saja dan di mana saja. 
                                Anda tidak perlu khawatir tentang kehilangan data atau masalah akses. 
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="column s-about__feature-item">
                            ...
                            <div class="s-about__feature-text">
                                ...
                                <p>Sistem menyederhanakan proses pemesanan lapangan dan pengelolaan jadwal pemesanan. 
                                    Antarmuka yang intuitif memungkinkan Anda untuk memeriksa ketersediaan lapangan dan mengatur pemesanan dengan cepat dan efisien.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="column s-about__feature-item">
                            ...
                            <div class="s-about__feature-text">
                                ...
                                <p>Keamanan data adalah prioritas utama. Dengan enkripsi dan protokol keamanan canggih, 
                                    sistem ini melindungi informasi Anda dari akses yang tidak sah, 
                                    sehingga Anda bisa tenang mengetahui semua data aman.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="column s-about__feature-item">
                            ...
                            <div class="s-about__feature-text">
                                <h3 class="h5">Event Organizer</h3>
                                <p>Fitur ini memberikan sebuah layanan untuk melakukan manajemen Event dimana pengguna dapat melihat event yang akan di selenggarakan. 
                                    Sehingga  dapat memanjemen pemesanan yang berbeda dan teroganisir
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="column s-about__feature-item">
                            ...
                            <div class="s-about__feature-text">
                                <h3 class="h5">Reporting and Analytics</h3>
                                <p>Fitur laporan memberikan wawasan mendalam tentang penggunaan lapangan dan pendapatan. 
                                    Anda dapat menganalisis kinerja dan mendapatkan data 
                                    penting untuk membantu pengambilan keputusan yang lebih baik.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="column s-about__feature-item">
                            ...
                            <div class="s-about__feature-text">
                                <h3 class="h5">Transaction Management</h3>
                                <p>sistem pembayaran yang aman dan nyaman. Sistem kami mendukung berbagai metode pembayaran,
                                     memungkinkan pengguna untuk menyelesaikan transaksi dengan cepat dan efisien. 
                                </p>
                            </div>
                        </div>
