...
<html lang="en">
  ...
  <head>
   ...
   <!-- Bootstrap core CSS -->
    ...
    <link rel="stylesheet" href="<?php echo base_url('assets/frontend/assets/css/fontawesome.css'); ?>">
    <link rel="stylesheet" href="<?php echo base_url('assets/frontend/assets/css/templatemo-villa-agency.css'); ?>">
    <link rel="stylesheet" href="<?php echo base_url('assets/frontend/assets/css/owl.css'); ?>">
...
<!-- Baru JS lain yang bergantung pada jQuery -->
...
<script src="<?php echo base_url('assets/frontend/assets/js/counter.js'); ?>"></script>
